...
Plotpoint is a real-world experience, and our first story takes place in San Francisco. It makes sense to market in the same physical space where the adventure will unfold.

Online posts are great, but their reach is diffused and unpredictable, especially without ad spend. Flyering lets me meet my target users where they are: outside, on a sunny Sunday, hanging out with friends, looking for adventure.

## Why use Partiful?

On the surface, it might seem strange to direct people to a third-party event app instead of my own waitlist website.

Right now, my priority is not to create a captive email list of prospects I can target with a drip campaign. My goal is to find people who are excited about what we’re doing, and provide them with a fun, happy experience. I’m not trying to sell anyone anything, I just want to see if what we’re building works and if people enjoy using it.

Hence, Partiful. It’s an event scheduling app that’s been popular for the past couple years. People use it for everything from organizing birthday parties to [Dev Patel Lookalike Contests](https://www.sfchronicle.com/entertainment/article/sf-dev-patel-lookalike-contest-winner-19891025.php). We are still getting the “existing platform” benefit that posting on LinkedIn or Instagram would provide, but the vibes are quite different. That’s important.

This is about finding a community and providing them with a fun, no-pressure way to see what we’re working on.
